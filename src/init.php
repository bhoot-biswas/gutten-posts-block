 ...
 * @since 1.0.0
 */
function gutten_posts_block_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'gutten_posts_block-cgb-style-css', // Handle.
	...
	wp_register_style(
		'gutten_posts_block-cgb-block-editor-css', // Handle.
	...
	wp_localize_script(
		'gutten_posts_block-cgb-block-js',
